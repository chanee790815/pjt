...
def view_solar(sh):
    ...
    # [설정] index=4: 서산(당진)을 기본값으로 선택 ("충주","서울","인천","수원","서산(당진)"...)
    sel_stn = col1.selectbox("분석 지점", ["충주", "서울", "인천", "수원", "서산(당진)", "청주", "부산"], index=4)
    
    # [설정] index=1: 2025년을 기본값으로 선택
